...
import { colsData_semesters as colsData } from '../../utils/columns_tables';
...
const Semesters = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Semesters'));
    });
    ...
    const cols = [
        {
            ...
            render: (data: any) => <ActionsRow editFN={() => navigate(`/semesters/mng/${data.id}`)} deleteFN={() => setModal({ status: true, activeID: data.id })} />,
        },
            ...
            <div className="panel ">
                <div className="flex items-center justify-between  ltr:ml-auto rtl:mr-auto mb-3">
                    <div className="flex items-center gap-5">
                        ...
                        {/* ADD BUTTUN */}
                        {cookie.get('user')?.type !== 'org' && <AddLink link={'/semesters/mng/new'} title="فصل" />}
                    </div>
                    <div className="flex justify-center items-center gap-4">
                        <Link to="/sortabSemester">
