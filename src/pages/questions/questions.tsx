...
import { colsData_questions as colsData } from '../../utils/columns_tables';
...
const Questions = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('questions'));
    });
    ...
    const cols = [
        {
            ...
            render: (data: any) => <ActionsRow editFN={() => navigate(`/questions/mng/${data.id}`)} deleteFN={() => setModal({ status: true, activeID: data.id })} />,
        },
            ...
            <div className="panel ">
                <div className="flex items-center justify-between ltr:ml-auto rtl:mr-auto mb-3">
                    <div className="flex items-center gap-5">
                        ...
                        {/* ADD BUTTUN */}
                        {cookie.get('user')?.type !== 'org' && <AddLink link={'/questions/mng/new'} title="الاسئله" />}
                    </div>
                    <div>
