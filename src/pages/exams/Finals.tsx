...
import { colsData_final as colsData, semseters_names, success_status_data } from '../../utils/columns_tables';
...
const url = '/api/admin/final';

let searchTimeout: any = null;
const Finals = () => {
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('Finals'));
    });
    ...
    function handleDownloadExcel() {
        downloadExcel({
            fileName: 'تقرير اختبارات نهاية الفصول',
    ...
    const cols = [
        ...
        //     render: (data: any) => <ActionsRow editFN={() => navigate(`/exams/final/mng/${data.id}`)} deleteFN={() => setModal({ status: true, activeID: data.id })} />,
        // },
        ...
        <div>
            ...
            <div className="panel">
                <div className="flex items-center flex-wrap gap-5 ltr:ml-auto rtl:mr-auto mb-3 ">
                    ...
                    <div className="text-right">
                        <input type="text" className="form-input" placeholder="بحث بإسم المادة" value={searchCourse} onChange={(e) => setSearchCourse(e.target.value)} />
                    </div>
                    ...
                    {/* ADD BUTTUN */}
                    {/* <AddLink link={'/exams/final/mng/new'} title="اختبار ميدتيرم" /> */}
                </div>
