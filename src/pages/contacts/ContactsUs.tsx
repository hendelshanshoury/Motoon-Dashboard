...
import { colsData_contacts as colsData } from '../../utils/columns_tables';
    ...
    const cols = [
        {
            ...
            render: (data: any) => <ActionsRow editFN={() => navigate(`/contacts/${data.id}`)} deleteFN={() => setModal({ status: true, activeID: data.id })} />,
        },
