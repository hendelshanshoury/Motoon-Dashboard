...
const MngCode = () => {
    const createUrl = '/api/admin/codes';
    const updateUrl = '/api/admin/codes';
    ...
    return (
        <>
            <div className="py-2">
                {/* BREADCRUMBS */}
                <MainBreadcrumbs links={[{ name: 'اداره اكواد التسجيل', src: '/codes' }]} />
                {/* FORM */}
                <div className="panel">
                            ...
                            <Form className={`space-y-5 ${loading ? 'pointer-events-none' : ''}`}>
                                <InputGroup className="grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex">
                                            <Field dir="auto" disabled={!isNew} name={`code`} type="text" id="code" className="form-input" />
                                            <button type="button" className="btn btn-primary" disabled={!isNew} onClick={() => setFieldValue('code', generateNumber())}>
                                                <LoadIcon generate />
                                            </button>
                                        </div>
