...
import { colsData_org as colsData } from '../../utils/columns_tables';
    ...
    const cols = [
        {
            ...
            render: (data: any) => <ActionsRow editFN={() => navigate(`/organizations/mng/${data.id}`)} deleteFN={() => setModal({ status: true, activeID: data.id })} />,
        },
        ...
        <div>
            ...
            <div className="panel ">
                <div className="flex items-center gap-5 ltr:ml-auto rtl:mr-auto mb-3">
                    ...
                    {/* ADD BUTTUN */}
                    {cookie.get('user')?.type !== 'org' && <AddLink link={'/organizations/mng/new'} title="جمعية" />}
                </div>
