...
const MngUser = () => {
    const createUrl = '/api/admin/users/create';
    const updateUrl = '/api/admin/users/edit';
                    ...
                    <Formik enableReinitialize initialValues={data} validationSchema={isNew ? SubmittedCreateForm : SubmittedUpdateForm} onSubmit={isNew ? submitCreateForm : updateUserAdminForm}>
                        {({ touched, errors }) => (
                            <Form className="space-y-5">
                                ...
                                <InputGroup className="grid-cols-1 md:grid-cols-2" errorToast={errors}>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <Field dir="auto" name="name_ar" type="text" id="name_ar" className="form-input" />
                                    ...
                                    <div>
                                        ...
                                        <Field dir="auto" name="national_id" type="text" id="national_id" className="form-input" />
                                        {touched.national_id && <ErrMsg name="national_id" />}
                                    </div>
                                    <div>
                                        <label htmlFor="country">الجنسية</label>
                                        <Field className="form-select" dir="auto" as="select" name="country" id="country">
                                            {countries.map((opt) => (
                                    ...
                                    <div>
                                        ...
                                        <Field className="form-select" dir="auto" as="select" name="city" id="city">
                                            {countries.map((opt) => (
                                                <option key={opt?.value} value={opt?.value}>
                                                    {opt?.label}
                                                </option>
                                    ...
                                    <div>
                                        ...
                                        <Field dir="auto" name="birthdate" type="date" id="birthdate" className="form-input" />
                                        {touched.birthdate && <ErrMsg name="birthdate" />}
                                    </div>
                                    <div>
                                        <label htmlFor="email_verified_at">تفعيل المستخدم</label>
                                        <Field dir="auto" name="email_verified_at" type="date" id="email_verified_at" className="form-input" />
                                        {touched.email_verified_at && <ErrMsg name="email_verified_at" />}
                                    </div>
                                    <div>
                                        <div>
                                            <label htmlFor="gender">النوع</label>
                                            <Field className="form-select" dir="auto" as="select" name="gender" id="gender">
                                    ...
                                    <div>
                                        <Field dir="auto" field="text" name="batch_id" id="batch_id">
                                            {({ field, form, meta }) => (
                                                <Searchable
                                                    defaultVal={form?.values?.batch_id ? { value: form?.values?.batch_id, label: form?.values?.batch_code } : null}
                                                    form={form}
                                                    field={field}
                                                    ttl="الدفعة"
                                                    label="code"
