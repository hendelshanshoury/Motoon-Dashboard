...
const BookmarkIcon: FC<BookmarkIconProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`w-5 h-5 cursor-pointer ${className}`}>
            <path
                ...
                strokeWidth="1.5"
            ></path>
            <path opacity="0.5" d="M15 6H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
        </svg>
    );
};
